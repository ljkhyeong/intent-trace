...
[0.12.0 후속 개선 검토](docs/reviews/2026-09-05-v0.12-follow-up-review.md)에 숨긴 토큰 입력 실패 처리, 잠금 파일과 배포 의존성 일치, 진행할 수 없는 조회 제한·재개 안내를 제안했다. 앞의 두 항목은 임시 환경에서 재현했고 조회 재개는 코드 경로로 확인했다. 아직 수정하지 않았다.
