...
- 화면·Markdown·MCP·Zed·문서의 문구 개선안 40개 반영과 모바일 안내의 단어 단위 줄바꿈
...
[추가 문구 검토](docs/reviews/2026-09-05-wording-follow-up-review.md)에 서버 오류·연결 관리·검색·플러그인 소개의 수정안 12개를 정리했다. 요청 충돌의 원인, 해시 불일치, 전체 연결 종료 범위와 토큰 발급 안내 4개를 우선 수정 대상으로 잡았다. 아직 제품 문구에는 반영하지 않았다.
