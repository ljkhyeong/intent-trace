...
[0.11.0 후속 개선 검토](docs/reviews/2026-09-05-v0.11-follow-up-review.md)에 개별 코드 확인의 지원 불가 안내, 웹 목록 필터, 과거 조회의 전체 시간·호출 수 제한, Zed 연결 도구 배포를 제안했다. 아직 구현하지 않았으며, Zed의 공식 MCP 레지스트리 전환 계획을 배포 방향에 반영했다.
